...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// Check for an contact address:
	if (empty($_POST['contact_address'])) {
		$errors[] = 'You forgot to enter your contact address.';
	} else {
		$a = trim($_POST['contact_address']);
	}
	...
	// Register the user in the database...
		...
		// Make the query:
		$q = "INSERT INTO users (user_id, fname, lname, email, date_of_birth, contact_address, psword,registration_date) VALUES (' ', '$fn', '$ln', '$e', '$d', '$a', SHA1('$p'), NOW() )";		
...
<form action="register-page.php" method="post">
	...
	<p><label class="label" for="date_of_birth">Date of Birth:</label><input id="date_of_birth" type="date" name="date_of_birth" size="30" maxlength="40" value="<?php if (isset($_POST['date_of_birth'])) echo $_POST['date_of_birth']; ?>"></p>

	<p><label class="label" for="contact_address">Contact Address:</label><input id="contact_address" type="text" name="contact_address" size="30" maxlength="40" value="<?php if (isset($_POST['contact_address'])) echo $_POST['contact_address']; ?>"></p>

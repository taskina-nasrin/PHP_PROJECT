<style type="text/css">
ul { position:absolute; top:190px; left:-10px; color:#269525; width:135px; text-align:center; margin:0;
}
...
li a { display: block; width:115px; color: #d6e1d7; font-weight: bold; text-decoration: none
}
/* specify state styles. */
/* mouseout (default) */
li a { background: #269525; border: 4px outset #aabaff;
}
/* mouseover */
li a:hover { display:block; background: green; border: 4px outset #8abaff; width:115px;
}
/* onmousedown */
